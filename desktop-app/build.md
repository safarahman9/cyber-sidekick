# Building the Cybersafety Superhero desktop installer
...
- **Windows** → `dist/Cybersafety Superhero Setup <version>.exe` (NSIS
  ...
  capstone deadline.
- **Mac** → `dist/Cybersafety Superhero-<version>.dmg`. Must be built on
  ...
  in the user manual.
- **Linux** → `dist/Cybersafety Superhero-<version>.AppImage`. Can be built
